    ...
    <div className="flex lg:hidden  justify-between px-4 py-3 sticky bottom-0 bg-white z-20 shadow-[inset_0_0_0_1px_#E0E4EA]">
        ...
        >
          <Link to={"/"}>
            ...
            >
              <path
                fill={activeTab === "home" ? "#335CFF" : "#525866"}
                fillRule="evenodd"
        ...
        <div className={`${activeTab === "search" ? "bg-[#EBF1FF]": ''} px-6 py-1 rounded-sm`} onClick={() => setActiveTab("search")}>
          <a>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
            ...
            >
              <path
                fill={activeTab === "search" ? "#335CFF" : "#525866"}
                fill-rule="evenodd"
        ...
        <div className={`${activeTab === "archive" ? "bg-[#EBF1FF]": ''} px-6 py-1 rounded-sm`} onClick={() => setActiveTab("archive")}>
          <a>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
            ...
            >
              <path
                stroke={activeTab === "archive" ? "#335CFF" : "#525866"}
        ...
        <div onClick={onTabs} className={`${activeTab === "tags" ? "bg-[#EBF1FF]": ''} px-6 py-1 rounded-sm`}>
          <a>
            ...
            >
              <path
                stroke={activeTab === "tags" ? "#335CFF" : "#525866"}
                stroke-linecap="round"
                stroke-linejoin="round"
                stroke-width="1.8"
        ...
        <div className={`${activeTab === "settings" ? "bg-[#EBF1FF]": ''} px-6 py-1 rounded-sm`} onClick={() => setActiveTab("settings")}>
          <a>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
            ...
            >
              <path
                fill={activeTab === "settings" ? "#335CFF" : "#525866"}
                fill-rule="evenodd"
